    ...
    <div className=''>
      <form className='mx-auto max-w-screen-md'>
        {fields.map((field, index) => (
          <div key={field.id}>
            <h4 className='font-bold mb-3 text-darkBlue'>Referencia Personal {index + 1}</h4>
            <div className='w-full mb-3'>

              <div className='flex flex-col w-full'>
                <input type='hidden' {...register(`personalReferences.${index}.customerId`)} />
                <label className='text-sm text-darkBlue'>Nombres Completos*</label>
                <Input
                  type='text'
            ...
            <div className='flex flex-col w-full mb-3 gap-3 sm:flex-row'>
              <div className='flex flex-col w-full'>
                <label className='text-sm text-darkBlue'>Tiempo de conocerlo*</label>
                <Input
                  type='text'
