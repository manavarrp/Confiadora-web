...
function RegisterForms ({ initialValues }) {
  ...
  const [modal, setModal] = useState({ open: false, callBack: null })
      ...
      <FormProvider {...methods}>
        <form className='mx-auto max-w-screen-md'>
          ...
          <div className='flex flex-col  mb-3 gap-3 sm:flex-row'>
            <div className=''>
              <label className='text-sm text-darkBlue ml-1'>País de residencia*</label>
              <ResidenceCountry />
            </div>
            <div className=''>
              <label className='text-sm text-darkBlue ml-1'>País de domicilio*</label>
              <DomicileCountry />
            </div>
            <div className='w-full'>
              <label className='text-sm text-darkBlue ml-1'>Código Postal*</label>
              <Input
                type='text'
          ...
          <div className='flex flex-col w-full mb-3 gap-3 sm:flex-row'>
            ...
            <div className='flex flex-col w-1/4'>
              <label className='text-sm text-darkBlue'>Primera entre calle</label>
              <Input
                type='text'
            ...
            <div className='flex flex-col w-1/4'>
              <label className='text-sm text-darkBlue'>Segunda entre calle</label>
              <Input
                type='text'
          ...
          <div className='flex justify-between mt-5'>
            <button
              type='button'
              onClick={onSubmitPersonFormBack}
            ...
            <button
              type='button'
              onClick={onSubmitPersonFormNext}
              className=' border bg-darkBlue w-1/4 h-12 rounded-lg text-white text-xl shadow-sm text-center'
            >
              Siguiente
            </button>
        ...
        <ModalResetData onClose={() => { setModal({ open: false, callBack: null }) }} onSubmit={modal.callBack} open={Boolean(modal.open)} />
      </FormProvider>
    </div>
  )
}
