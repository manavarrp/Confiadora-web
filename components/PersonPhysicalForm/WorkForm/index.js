...
function RegisterForms ({ initialValues }) {
  ...
  const onSubmitWorkFormUpdate = (data) => {
    const payload = {
    ...
    postPersonPhysicalData(payload, 'natural-person/employment-information')
        ...
        <form className='mx-auto max-w-screen-md'>
          <div className='flex flex-col w-full mb-3 gap-3 sm:flex-row'>
            <div className='flex flex-col w-full'>
              <label className='text-sm text-darkBlue'>Nombre de la Institución en la que labora*</label>
              <Input
                type='text'
          ...
          <div className='flex flex-col w-full mb-3 gap-3 sm:flex-row'>
            <div className='flex flex-col w-full mb-3 gap-3 sm:flex-row'>
              <div className='flex flex-col w-full'>
                <label className='text-sm text-darkBlue'>Puesto/Profesión*</label>
                <Input
                  type='text'
            ...
            <div className='flex flex-col '>
              <label className='text-sm text-darkBlue'>Actividad Economica*</label>
          ...
          <div className='w-full mb-3 bg-white'>
            <label className='text-darkBlue'>Adjuntar talonarios de pago 3 últimos.</label>
            ...
            <div className='flex-row justify-between items-center'>
              ...
              <div className='flex overflow-auto mb-3 p-2'>
                {
                 selectedImage && [...selectedImage].map((file, index) => <img key={index} src={URL.createObjectURL(file)} className='w-32 h-32 mr-1 rounded-sm border-2' />)
                }

              </div>

              {selectedImage &&
                <button onClick={removeSelectedImage} className='border bg-red w-[30%] h-10 rounded-lg text-white text-xl shadow-sm text-center'>
                  Eliminar
                </button>}
