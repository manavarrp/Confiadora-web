...
function RegisterForms ({ initialValues }) {
  ...
  const onSubmitComplementaryForm = (data) => {
    const payload = {
      ...
      operatedResourcesBenefitThirdParty:
        data.operatedResourcesBenefitThirdParty,
      ...
      <form className='mx-auto max-w-screen-md'>
        ...
        <div className='mb-6 bg-white'>
          ...
          <label className='flex justify-center my-3 p-2 text-sm'>
            En caso de utilizar dinero en efectivo, favor especificar monto
            estimado mensual.*
          </label>
          <Input
            type='text'
        ...
        <div className='mb-6 bg-white'>
          ...
          <label className='text-gray italic text-sm'>
            En caso positivo, se debe anexar un nuevo formulario, el cual será
            proporcionado por uno de nuestros asesores posteriormente.
          </label>
        </div>
